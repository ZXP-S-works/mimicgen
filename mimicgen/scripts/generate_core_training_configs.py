    ...
    all_settings = [
        ...
        dict(
            dataset_paths=[
                ...
                os.path.join(dataset_dir, "square", "demo_src_square_task_D3/demo.hdf5"),
            ],
            dataset_names=[
                "square_D0",
                "square_D1",
        ...
        dict(
            dataset_paths=[
                ...
                os.path.join(dataset_dir, "threading", "demo_src_threading_task_D3/demo.hdf5"),
            ],
            dataset_names=[
                "threading_D0",
                "threading_D1",
        ...
        dict(
            dataset_paths=[
                ...
                os.path.join(dataset_dir, "three_piece_assembly", "demo_src_three_piece_assembly_task_D3/demo.hdf5"),
            ],
            dataset_names=[
                "three_piece_assembly_D0",
                "three_piece_assembly_D1",
                "three_piece_assembly_D2",
                "three_piece_assembly_D3",
            ],
            horizon=500,
        ),
        # coffee
        dict(
            dataset_paths=[
                ...
                os.path.join(dataset_dir, "coffee", "demo_src_coffee_task_D3/demo.hdf5"),
            ],
            dataset_names=[
                "coffee_D0",
                "coffee_D1",
