...
def make_generators(base_configs):
    ...
    all_settings = [
        ...
        dict(
            ...
            tasks=["Square_D0", "Square_D1", "Square_D2", "Square_D3", "Square_D4"],
        ...
        dict(
            ...
            tasks=["Threading_D0", "Threading_D1", "Threading_D2", "Threading_D3", "Threading_D4"],
            task_names=["D0", "D1", "D2", "D3", "D4"],
            select_src_per_subtask=False,
        ...
        dict(
            ...
            tasks=["ThreePieceAssembly_D0", "ThreePieceAssembly_D1", "ThreePieceAssembly_D2",
                   "ThreePieceAssembly_D3", "ThreePieceAssembly_D4"],
            task_names=["D0", "D1", "D2", "D3", "D4"],
            select_src_per_subtask=False,
            selection_strategy="random",
            selection_strategy_kwargs=None,
        ...
        dict(
            ...
            tasks=["Coffee_D0", "Coffee_D1", "Coffee_D2", "Coffee_D3", "Coffee_D4"],
            task_names=["D0", "D1", "D2", "D3", "D4"],
            select_src_per_subtask=False,
            selection_strategy="random",
            selection_strategy_kwargs=None,
